        ...
        <div className="bg-[#818CF8] rounded-[2.5rem] p-8 md:p-16 text-center text-white relative overflow-hidden shadow-2xl shadow-indigo-500/30">
          ...
          <div className="relative z-10 max-w-3xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <button className="w-full sm:w-auto px-8 py-4 bg-slate-800 text-white rounded-xl font-semibold flex items-center justify-center gap-3 -translate-y-1 shadow-lg">
                <Apple size={24} />
